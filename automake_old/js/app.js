...
const MODELS = [
  ...
  { id: "o6", file: "o6", name: "O6", title: "Frames, then blocks", scripts: ["frame", "block"],
    ...
    numbers: "O6 on walls it had not seen, beyond the training range: framed walls precision 0.93, recall 0.89 (N0: 0.91 / 0.88); concrete block walls 0.85 / 0.84 with the world refusing overlaps, against O4's 0.73 / 0.71 (120 runs each)." },
...
const PRESETS = [
  ...
  { label: "The same wall after learning blocks", sub: "O6 · its framing kept", model: "o6", design: D("frame", 5.8, 2.7, THREE) },
  ...
  { label: "Finish a half-built block wall", sub: "O6 · its blocks after 50 minutes", model: "o6", design: D("block", 5.4, 2.7, [door(0.6, 0.9, 2.1), win(2.8, 1.6, 1.2, 0.9)], { start: "prefix", share: 0.5 }) },
  { label: "The world refuses overlaps", sub: "O6 · blocks with holes, a rule outside the network", model: "o6", design: D("block", 5.8, 2.7, [door(0.3, 0.9, 2.1), win(1.7, 0.8, 1.2, 0.9), win(3.0, 1.0, 1.2, 0.9), door(4.5, 1.0, 2.1)], { start: "subset", share: 0.6, reject: true }) },
